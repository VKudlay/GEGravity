...
Before proceeding, further pre-processing is needed. Specifically, the function needs to get a series
...
# Data to be finally fed to the function (we baee the counterfactual on the year 2000.)
...
So now, we have data, so we should be able to run the ge_gravity function as follows:
