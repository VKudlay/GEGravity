...
aggregated trade flows based on WIOD and information on FTAs is from the {browse: "https://sites.nd.edu/jeffrey-bergstrand/database-on-economic-integration-agreements/" NSF-Kellogg database} maintained
